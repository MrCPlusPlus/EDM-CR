...
class GaussianDiffusion:
    ...
    def p_sample_loop_outputsample(
        self,
        y,
        model,
        first_stage_model=None,
        ...
        """
        final = None
        for sample, sample_list in self.p_sample_loop_progressive_outputsample(
            y,
            model,
            first_stage_model=first_stage_model,
            noise=noise,
    ...
    def p_sample_loop_progressive_outputsample(
            self, y, model,
            first_stage_model=None,
            noise=None,
            noise_repeat=False,
...
class GaussianDiffusionDDPM:
    ...
    def p_sample_loop(
        ...
        for sample in self.p_sample_loop_progressive(
            ...
            final = sample
        return final["sample"]# self.decode_first_stage(final["sample"], first_stage_model)
